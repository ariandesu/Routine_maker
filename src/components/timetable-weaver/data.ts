...
export const themes = [
    ...
    { label: 'Lavender Bliss', value: 'theme-lavender' },
    { label: 'Minty Fresh', value: 'theme-mint' },
    { label: 'Peachy Keen', value: 'theme-peach' },
    { label: 'Cool Slate', value: 'theme-slate' },
    { label: 'Warm Coffee', value: 'theme-coffee' },
    { label: 'Cherry Red', value: 'theme-cherry' },
    { label: 'Sky Blue', value: 'theme-sky' },
    { label: 'Golden Honey', value: 'theme-honey' },
    { label: 'Grape Soda', value: 'theme-grape' },
    { label: 'Deep Teal', value: 'theme-teal' },
    { label: 'Desert Sand', value: 'theme-sand' },
    { label: 'Plum Passion', value: 'theme-plum' },
    { label: 'Olive Grove', value: 'theme-olive' },
    { label: 'Coral Reef', value: 'theme-coral' },
    { label: 'Steel Gray', value: 'theme-steel' },
    { label: 'Ruby Wine', value: 'theme-wine' },
    { label: 'Electric Lime', value: 'theme-lime' },
    { label: 'Royal Purple', value: 'theme-royal' },
    { label: 'Apricot Sunset', value: 'theme-apricot' },
    { label: 'Midnight Navy', value: 'theme-navy' },
    { label: 'Butter Yellow', value: 'theme-butter' },
];
